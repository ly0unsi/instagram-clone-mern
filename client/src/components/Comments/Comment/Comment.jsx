    ...
    <div className='flex items-center gap-2 mt-2'>
      ...
      <div >
        ...
        <div className='flex relative' ref={ref}>
          <textarea disabled={textDis} ref={textAreaRef} style={{ border: !textDis && "1px solid black" }} className='dark:bg-zinc-900 outline-none comment-text' value={formdata.body} onChange={handleChange} cols={50} />
          {
